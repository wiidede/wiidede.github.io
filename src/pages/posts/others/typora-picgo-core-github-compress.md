...
3. 添加配置文件（更换wiidede/img-store-one成自己的仓库）
   ...
   ```json
   {
     "picBed": {
       ...
       "github": {
         "branch": "main",
         "customUrl": "https://wiidede.space/img-store-one", // "https://raw.githubusercontent.com/wiidede/img-store-one/master"
         "path": "images/",
...
4. 然后成功
   ...
   ![image-20220504082530013](https://wiidede.space/img-store-one/images/image-20220504082530013.png)
...
6. 测试最终效果(我是个憨批，把token放出来了，下图的已经没用了，马上就换了一个😑)
   ...
   ![image-20220504085315955](https://wiidede.space/img-store-one/images/image-20220504085315955.webp)
