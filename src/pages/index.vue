...
<template>
  <div class="slide-enter-content m-auto max-w65ch text-left">
    ...
    <h1 class="mb2 text-8 text-zinc-900">
    ...
    <div class="mx--2 mb8 space-x-4">
      <a
        ...
        :key="idx"
        :href="contact.href"
        class="rd px2 py-1 hover:bg-zinc-100"
    ...
    <h2 class="mb4 mt12 text-7 text-zinc-900">
      项目
    </h2>
    ...
    <div class="grid grid-cols-1 mx--2 md:grid-cols-2">
      <a
        ...
        target="_blank"
        class="w-full flex items-center gap1 rd p2 transition hover:bg-zinc-100"
      >
        <img
